...
"[project]/src/app/author/dashboard/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>AuthorDashboard)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
...
function AuthorDashboard() {
    ...
    const [authorBooks, setAuthorBooks] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [bookSales, setBookSales] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const [bookReviews, setBookReviews] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const [followers, setFollowers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [filter, setFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('all');
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthorDashboard.useEffect": ()=>{
            ...
            try {
                ...
                if (loggedInUser) {
                    ...
                    const userBooks = allPublishedBooks.filter({
                        "AuthorDashboard.useEffect.userBooks": (book)=>book.authorId === parsedUser.id
                    }["AuthorDashboard.useEffect.userBooks"]);
                    setAuthorBooks(userBooks);
                    // Load transactions and calculate stats
                    const allTransactions = JSON.parse(localStorage.getItem('transactions') || '[]');
                    const authorTransactions = allTransactions.filter({
                        "AuthorDashboard.useEffect.authorTransactions": (txn)=>userBooks.some({
                                "AuthorDashboard.useEffect.authorTransactions": (b)=>b.id === txn.bookId
                            }["AuthorDashboard.useEffect.authorTransactions"])
                    }["AuthorDashboard.useEffect.authorTransactions"]);
                    const revenue = authorTransactions.reduce({
                        "AuthorDashboard.useEffect.revenue": (acc, txn)=>acc + txn.amount
                    }["AuthorDashboard.useEffect.revenue"], 0);
                    setTotalRevenue(revenue);
                    const sales = authorTransactions.reduce({
                        "AuthorDashboard.useEffect.sales": (acc, txn)=>acc + txn.quantity
                    }["AuthorDashboard.useEffect.sales"], 0);
                    setTotalSales(sales);
                    const salesByBook = authorTransactions.reduce({
                        "AuthorDashboard.useEffect.salesByBook": (acc, txn)=>{
                            acc[txn.bookId] = (acc[txn.bookId] || 0) + txn.quantity;
                            return acc;
                        }
                    }["AuthorDashboard.useEffect.salesByBook"], {});
                    setBookSales(salesByBook);
                    // Load reviews and calculate stats
                    const allReviews = JSON.parse(localStorage.getItem('bookReviews') || '[]');
                    const reviewsByBook = userBooks.reduce({
                        "AuthorDashboard.useEffect.reviewsByBook": (acc, book)=>{
                            const bookReviews = allReviews.filter({
                                "AuthorDashboard.useEffect.reviewsByBook.bookReviews": (r)=>r.bookId === book.id
                            }["AuthorDashboard.useEffect.reviewsByBook.bookReviews"]);
                            const totalRating = bookReviews.reduce({
                                "AuthorDashboard.useEffect.reviewsByBook.totalRating": (sum, r)=>sum + r.rating
                            }["AuthorDashboard.useEffect.reviewsByBook.totalRating"], 0);
                            acc[book.id] = {
                    ...
                    }["AuthorDashboard.useEffect.reviewsByBook"], {});
                    setBookReviews(reviewsByBook);
                    // Calculate Followers
                    const userFollows = JSON.parse(localStorage.getItem('userFollows') || '{}');
                    const followerCount = Object.values(userFollows).filter({
                        "AuthorDashboard.useEffect": (followedAuthors)=>followedAuthors.includes(parsedUser.id)
                    }["AuthorDashboard.useEffect"]).length;
    ...
    const filteredBooks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuthorDashboard.useMemo[filteredBooks]": ()=>{
            if (filter === 'outOfStock') {
                return authorBooks.filter({
                    "AuthorDashboard.useMemo[filteredBooks]": (book)=>book.stock === 0
                }["AuthorDashboard.useMemo[filteredBooks]"]);
            }
            if (filter === 'lowStock') {
                return authorBooks.filter({
                    "AuthorDashboard.useMemo[filteredBooks]": (book)=>book.stock > 0 && book.stock <= book.reorderPoint
                }["AuthorDashboard.useMemo[filteredBooks]"]);
            }
            return authorBooks;
        }
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                ...
                                fileName: "[project]/src/app/author/dashboard/page.tsx",
                                lineNumber: 149,
                                columnNumber: 13
                            }, this),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "Based on completed sales"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/author/dashboard/page.tsx",
                                        lineNumber: 170,
                                        columnNumber: 13
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-xs text-muted-foreground",
                                        children: followers === 1 ? 'person follows you' : 'people follow you'
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/author/dashboard/page.tsx",
                                        lineNumber: 190,
                                        columnNumber: 14
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                children: "Manage your books, view sales, and edit details."
                            }, void 0, false, {
                                fileName: "[project]/src/app/author/dashboard/page.tsx",
                                lineNumber: 198,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        children: [
                            ...
                            authorBooks.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Table"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                                        children: filteredBooks.map((book)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                        children: bookReviews[book.id]?.count > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                            href: `/author/reviews/${book.id}`,
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    children: bookReviews[book.id].average.toFixed(1)
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/author/dashboard/page.tsx",
                                                                    lineNumber: 231,
                                                                    columnNumber: 27
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                        ...
                                        children: "You haven't published any books yet."
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/author/dashboard/page.tsx",
                                        lineNumber: 252,
                                        columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "Click the button below to get started."
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/author/dashboard/page.tsx",
                                        lineNumber: 253,
                                        columnNumber: 17
...
_s(AuthorDashboard, "m+OYf4oVZ7NLAib6CVi7ooVqtxM=", false, function() {
    return [
...
_c = AuthorDashboard;
var _c;
__turbopack_context__.k.register(_c, "AuthorDashboard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_c40fefeb._.js.map