...
function BookCard({ book, hasAccess = false }) {
    ...
    const handleAddToCart = (e)=>{
        ...
        if (existingItem) {
            ...
            // For the main cart, we still need the details, but we should be mindful of size.
            // Let's assume the cart won't grow excessively large with unique items.
...
//# sourceMappingURL=src_components_556623d5._.js.map