...
function CartPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartPage.useEffect": ()=>{
            setHasMounted(true);
            const lightweightCart = JSON.parse(localStorage.getItem('cart') || '[]');
            const allPublishedBooks = JSON.parse(localStorage.getItem('publishedBooks') || '[]');
            const hydratedCart = lightweightCart.map({
                "CartPage.useEffect.hydratedCart": (item)=>{
                    const bookDetails = allPublishedBooks.find({
                        "CartPage.useEffect.hydratedCart.bookDetails": (b)=>b.id === item.id
                    }["CartPage.useEffect.hydratedCart.bookDetails"]);
                    return bookDetails ? {
                        ...bookDetails,
                        quantity: item.quantity
                    } : null;
                }
            }["CartPage.useEffect.hydratedCart"]).filter({
                "CartPage.useEffect.hydratedCart": (i)=>i !== null
            }["CartPage.useEffect.hydratedCart"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartPage.useEffect": ()=>{
            if (hasMounted) {
                const lightweightCart = cartItems.map({
                    "CartPage.useEffect.lightweightCart": (item)=>({
                            id: item.id,
                            quantity: item.quantity
                        })
                }["CartPage.useEffect.lightweightCart"]);
    ...
    const updateQuantity = (id, newQuantity)=>{
        ...
        if (itemToUpdate && newQuantity > itemToUpdate.stock) {
            toast({
                variant: 'destructive',
                title: 'Stock Limit',
                description: `Only ${itemToUpdate.stock} copies available.`
            });
            return;
        }
            ...
            cartItems.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        className: "mt-4 text-2xl font-headline font-semibold",
...
_s(CartPage, "UscSLOMPGdvzJ1qRi9nfii7xo1M=", false, function() {
    return [
...
//# sourceMappingURL=src_c5fd3b51._.js.map