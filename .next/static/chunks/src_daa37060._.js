...
"[project]/src/app/reader/dashboard/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>ReaderDashboard)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-client] (ecmascript)");
...
function ReaderDashboard() {
    ...
    const [followedAuthorBooks, setFollowedAuthorBooks] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
        ...
        "ReaderDashboard.useEffect": ()=>{
            ...
            try {
                ...
                if (loggedInUserString) {
                    ...
                    const userBookIds = userLibraryData[loggedInUser.id] || [];
                    const booksInLibrary = allPublishedBooks.filter({
                        "ReaderDashboard.useEffect.booksInLibrary": (book)=>userBookIds.includes(book.id)
                    }["ReaderDashboard.useEffect.booksInLibrary"]);
                    ...
                    const followedAuthorIds = userFollows[loggedInUser.id] || [];
                    const booksFromFollowed = allPublishedBooks.filter({
                        "ReaderDashboard.useEffect.booksFromFollowed": (book)=>followedAuthorIds.includes(book.authorId)
                    }["ReaderDashboard.useEffect.booksFromFollowed"]).sort({
                        "ReaderDashboard.useEffect.booksFromFollowed": (a, b)=>parseInt(b.id.split('-')[1]) - parseInt(a.id.split('-')[1])
                    }["ReaderDashboard.useEffect.booksFromFollowed"]); // Sort by newest first
                    ...
                    const userGifts = allGifts.filter({
                        "ReaderDashboard.useEffect.userGifts": (gift)=>gift.recipientUserId === loggedInUser.id
                    }["ReaderDashboard.useEffect.userGifts"]);
                    const hydratedGifts = userGifts.map({
                        "ReaderDashboard.useEffect.hydratedGifts": (gift)=>{
                            const book = allPublishedBooks.find({
                                "ReaderDashboard.useEffect.hydratedGifts.book": (b)=>b.id === gift.bookId
                            }["ReaderDashboard.useEffect.hydratedGifts.book"]);
                            const giver = allUsers.find({
                                "ReaderDashboard.useEffect.hydratedGifts.giver": (u)=>u.id === gift.giverUserId
                            }["ReaderDashboard.useEffect.hydratedGifts.giver"]);
                            if (book && giver) {
                                return {
                                    ...gift,
                                    book,
                    ...
                    }["ReaderDashboard.useEffect.hydratedGifts"]).filter({
                        "ReaderDashboard.useEffect.hydratedGifts": (g)=>g !== null
                    }["ReaderDashboard.useEffect.hydratedGifts"]).sort({
                        "ReaderDashboard.useEffect.hydratedGifts": (a, b)=>new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: [
                            ...
                            "! Here's your personalized space."
                        ]
                    }, void 0, true, {
                        fileName: "[project]/src/app/reader/dashboard/page.tsx",
                        lineNumber: 104,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                            asChild: true,
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                                href: `/books/${libraryBooks[0].id}?fromLibrary=true`,
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: receivedGifts.slice(0, 3).map((gift)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: followedAuthorBooks.slice(0, 3).map((book)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$BookCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                    book: book,
...
//# sourceMappingURL=src_daa37060._.js.map