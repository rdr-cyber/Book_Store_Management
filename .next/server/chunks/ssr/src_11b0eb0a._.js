...
function BooksPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (hasMounted) {
            // In a real app, this would be an API call. Here we simulate it by reading from localStorage.
            const publishedBooks = JSON.parse(localStorage.getItem('publishedBooks') || '[]');
            // We combine sample books with newly published books for a richer collection.
            // In a real scenario, all books would come from a database.
            setBooks([
                ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sample$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["allBooks"],
                ...publishedBooks
            ]);
        }
    }, [
    ...
    const filteredBooks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        return books.filter((book)=>book.title.toLowerCase().includes(searchTerm.toLowerCase())).filter((book)=>selectedCategory === "All" || book.category === selectedCategory);
    }, [
        searchTerm,
        selectedCategory,
        books
...
//# sourceMappingURL=src_11b0eb0a._.js.map