    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrderConfirmationPage.useEffect": ()=>{
            ...
            if (storedOrderString) {
                ...
                const hydratedItems = storedOrder.items.map({
                    "OrderConfirmationPage.useEffect.hydratedItems": (item)=>{
                        const bookDetails = allPublishedBooks.find({
                            "OrderConfirmationPage.useEffect.hydratedItems.bookDetails": (book)=>book.id === item.id
                        }["OrderConfirmationPage.useEffect.hydratedItems.bookDetails"]);
                        return bookDetails ? {
                            ...bookDetails,
                            quantity: item.quantity
                        } : null;
                    }
                }["OrderConfirmationPage.useEffect.hydratedItems"]).filter({
                    "OrderConfirmationPage.useEffect.hydratedItems": (i)=>i !== null
                }["OrderConfirmationPage.useEffect.hydratedItems"]);
                const hydratedOrder = {
                    ...storedOrder,
                    items: hydratedItems
                };
...
_s(OrderConfirmationPage, "HOoBjzYuxWxNvZMQ7JyYTQkSiiI=");
...
//# sourceMappingURL=src_1b2ea580._.js.map