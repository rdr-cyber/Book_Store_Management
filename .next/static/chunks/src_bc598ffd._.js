...
function BooksPage() {
    ...
    const filteredBooks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BooksPage.useMemo[filteredBooks]": ()=>{
            ...
            return books.filter({
                "BooksPage.useMemo[filteredBooks]": (book)=>book.title.toLowerCase().includes(lowercasedTerm) || book.author.toLowerCase().includes(lowercasedTerm)
            }["BooksPage.useMemo[filteredBooks]"]).filter({
                "BooksPage.useMemo[filteredBooks]": (book)=>selectedCategory === "All" || book.category === selectedCategory
            }["BooksPage.useMemo[filteredBooks]"]);
        }
    }["BooksPage.useMemo[filteredBooks]"], [
        searchTerm,
    ...
    const categories = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BooksPage.useMemo[categories]": ()=>{
            const allCategories = [
                "All",
                ...new Set(books.map({
                    "BooksPage.useMemo[categories]": (book)=>book.category
                }["BooksPage.useMemo[categories]"]))
            ];
            // Remove duplicates
            return [
...
//# sourceMappingURL=src_bc598ffd._.js.map